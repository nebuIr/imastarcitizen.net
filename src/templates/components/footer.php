<div class="footer-right">
    ...
    <?= $locale['FOOTER_LOCALE'] ?>
</div>
<div class="footer-left">
    <p class="footer-links"><a href="/archive"><?= $locale['FOOTER_CARD_ARCHIVES'] ?></a> - <a href="/downloads"><?= $locale['FOOTER_DOWNLOADS'] ?></a> - <a href="https://robertspaceindustries.com"><?= $locale['FOOTER_RSI_HOMEPAGE'] ?></a> - <a href="https://instagram.com/robertsspaceind"><?= $locale['FOOTER_RSI_INSTAGRAM'] ?></a></p>
    <p><?= $locale['FOOTER_BY'] ?>
        <br>
        <br><?= $locale['FOOTER_FEEDBACK'] ?></p>
    <br>
    <a href="https://screferral.space/share/STAR-X3J2-5FGQ" target="_blank"><span style="font-size: small; "><?= $locale['FOOTER_REFERRAL'] ?></span></a>
    <br>
    <br>
